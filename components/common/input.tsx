...
const inputVariants = cva({
  base: "appearance-none min-h-0 w-full self-stretch bg-background text-secondary-foreground font-medium text-[0.8125rem]/tight break-words transition duration-150 disabled:text-secondary-foreground/50",
